...
def main():
	...
	for proc in psutil.process_iter():
		try:
			...
			if proc.name() == "nsrd.exe" or proc.name() == "nsrsnmd.exe" or proc.name() == "nsrctld.exe" or proc.name() == "nsrindexd.exe" or proc.name() == "nsrmmdbd.exe" or proc.name == "nsrdispd.exe" or proc.name() == "nsrlogd.exe" or proc.name() == "nsrvmwsd.exe" or proc.name() == "nsrjobd.exe" or proc.name() == "nsrexecd.exe":
#				print(pinfo)
